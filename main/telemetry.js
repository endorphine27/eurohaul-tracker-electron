...
function normalize(d) {
  ...
  return {
    ...
    // Indicatoare de bord, ca la Trucky (showGear/showRpm/showBrakeAirPressure/
    // showParkingBrake/showRetarderIndicator/showLights etc.).
    gear: typeof d.gearDashboard === 'number' ? d.gearDashboard : null,
    rpm: typeof d.engineRpm === 'number' ? Math.round(d.engineRpm) : null,
    airPressure: typeof d.airPressure === 'number' ? Math.round(d.airPressure) : null,
    parkBrakeOn: !!d.parkBrake,
    retarderLevel: typeof d.retarderBrake === 'number' ? d.retarderBrake : null,
    lightsBeamLow: !!d.lightsBeamLow,
    lightsBeamHigh: !!d.lightsBeamHigh,
    lightsBeacon: !!d.lightsBeacon,
    lightsHazard: !!d.lightsHazard,
    blinkerLeftOn: !!d.blinkerLeftOn,
